    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                    <div>
                        ...
                        {selectedCompany.formal_name && (
                            <p className="text-blue-100 mt-1">{selectedCompany.formal_name}</p>
                        )}
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Link to="/ledgers" className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition group">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-800">{summary?.ledgerCount || 0}</p>
                            </div>
                        </div>
                    </Link>

                    <Link to="/vouchers" className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition group">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-800">{summary?.voucherCount || 0}</p>
                            </div>
                        </div>
                    </Link>

                    <Link to="/stock" className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition group">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-800">{summary?.stockCount || 0}</p>
                            </div>
                        </div>
                    </Link>
            ...
            {!loading && summary && (
                <div className="grid md:grid-cols-2 gap-6">
                    <Link to="/sales" className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-gray-800">Total Sales</h3>
                            <span className="text-3xl">📈</span>
                        </div>
                        <p className="text-3xl font-bold text-green-600">{formatCurrency(summary.totalSales)}</p>
                        <p className="text-sm text-gray-500 mt-2">Click to view all sales invoices</p>
                    </Link>

                    <Link to="/purchases" className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-gray-800">Total Purchases</h3>
                            <span className="text-3xl">📉</span>
                        </div>
                        <p className="text-3xl font-bold text-red-600">{formatCurrency(summary.totalPurchases)}</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Link to="/ledgers" className="flex flex-col items-center p-4 bg-gray-50 rounded-xl hover:bg-blue-50 transition">
                        <span className="text-2xl mb-2">👥</span>
                        <span className="text-sm font-medium text-gray-700">Parties</span>
                    </Link>
                    <Link to="/sales" className="flex flex-col items-center p-4 bg-gray-50 rounded-xl hover:bg-green-50 transition">
                        <span className="text-2xl mb-2">🧾</span>
                        <span className="text-sm font-medium text-gray-700">Invoices</span>
                    </Link>
                    <Link to="/stock" className="flex flex-col items-center p-4 bg-gray-50 rounded-xl hover:bg-purple-50 transition">
                        <span className="text-2xl mb-2">📊</span>
                        <span className="text-sm font-medium text-gray-700">Stock Report</span>
                    </Link>
                    <Link to="/reports" className="flex flex-col items-center p-4 bg-gray-50 rounded-xl hover:bg-yellow-50 transition">
                        <span className="text-2xl mb-2">📋</span>
