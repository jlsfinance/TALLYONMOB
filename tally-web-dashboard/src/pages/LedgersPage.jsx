    ...
    return (
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Ledgers</h1>
                    <p className="text-gray-500 text-sm">All parties, banks, and accounts</p>
                </div>
                                ...
                                <div className="divide-y divide-gray-100">
                                    {items.map(ledger => (
                                        <Link
                                            ...
                                            className="flex items-center justify-between p-3 sm:p-4 hover:bg-gray-50 active:bg-gray-100"
                                        >
